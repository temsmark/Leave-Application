...
@section('content')
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-play "></i> Pending Applications</h1>
            </div>
                        ...
                        <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <tr>
                                ...
                                <td>@if ($request->status==0)
                                        <span class="badge badge-pill badge-primary small">Pending..</span>
                                @endif</td>
                                <td> <a href="{{url('approve/'.$request->id)}}" class="btn btn-primary btn-sm" role="button">Approve</a></td>
                                <td> <a href="{{url('decline/'.$request->id)}}" class="btn btn-danger btn-sm" role="button">Reject</a></td>
